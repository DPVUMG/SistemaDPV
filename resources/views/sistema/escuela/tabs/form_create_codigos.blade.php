                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="form-group{{ $errors->has('codigo') ? ' has-danger' : '' }}">
                            ...
                            <input class="form-control{{ $errors->has('codigo') ? ' is-invalid' : '' }}" name="codigo[]"
                                id="{{ " {$item->nombre}-{$item->codigo}" }}" type="text"
                            placeholder="{{
                            __('00-00-0000-00') }}"
                            value="{{ old('codigo') }}" aria-required="true" />
                            @if ($errors->has('codigo'))
                            <span id="codigo-error" class="error text-danger" for="{{ " {$item->nombre}-{$item->codigo}"
                                }}">{{
                    ...
                    <td class="text-center">
                        <div class="form-group{{ $errors->has('cantidad_alumno') ? ' has-danger' : '' }}">
                            ...
                            <span id="cantidad_alumno-error" class="error text-danger" for="input-cantidad_alumno">{{
