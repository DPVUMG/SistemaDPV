...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('presentacion.store') }}" autocomplete="off"
                    class="form-horizontal">
                    @csrf
                    @method('post')
                    <div class="card ">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">{{ __('Nueva presentacion') }}</h4>
                            <p class="card-category">{{ __('Registrar una nueva presentacion en el sistema') }}</p>
                        </div>
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }}">
                                        ...
                                        <input class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="{{ __('presentacion') }}" value="{{ old('nombre') }}"
                                            aria-required="true" />
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <a rel="tooltip" class="btn btn-flat btn-md btn-danger"
                                href="{{ route('presentacion.index') }}" data-toggle="tooltip" data-placement="top"
                                title="Cancelar">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-info">
                        <h4 class="card-title ">{{ __('Presentaciones') }}</h4>
                        <p class="card-category"> {{ __('En esta pantalla el sistema muestra todas las Presentaciones
                            registradas.') }}</p>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('presentacion.index') }}" autocomplete="off"
                            class="form-horizontal">
                            @csrf
                            @method('get')
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form method="post" action="{{ route('presentacion.destroy', $item) }}">
                                                @csrf
                                                @method('delete')
                                                <a rel="tooltip" class="btn btn-warning btn-sm btn-round"
                                                    href="{{ route('presentacion.edit', $item) }}" data-toggle="tooltip"
