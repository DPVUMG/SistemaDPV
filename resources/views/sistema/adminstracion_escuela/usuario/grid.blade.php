        ...
        <table class="dataTable display" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">{{ date('d/m/Y H:i:s', strtotime($item->persona->created_at))
                        }}</td>
                    <td class="text-center align-middle">{{ date('d/m/Y H:i:s', strtotime($item->persona->updated_at))
                        }}</td>
