@extends('layouts.app')
@section('title', 'Configuración Sistema WEB')
            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="url">Configuración Sistema WEB</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-nav-tabs text-center">
                    <div class="card-header card-header-success">{{ __('Información de la Configuración Sistema WEB') }}
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('configuracion.store') }}" autocomplete="off"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ old('ubicacion_x') }}" aria-required="true" />
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div
                                                        ...
                                                        <label for="ubicacion_y">latitud</label>
                                                        <input
                                                            ...
                                                            value="{{ old('ubicacion_y') }}" aria-required="true" />
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="{{ __('URL de página') }}"
                                                            value="{{ old('url') }}" aria-required="true" />
                                                        @if ($errors->has('url'))
                                        ...
                                        <div class="col-md-12">
                                            <a rel="tooltip" class="btn btn-flat btn-md btn-danger"
                                                href="{{ route('configuracion.index_sistema') }}" data-toggle="tooltip"
                                        ...
                                        <form method="post" action="{{ route('configuracion.telefono_store', $web) }}"
                                            ...
                                            <div class="card ">
                                                ...
                                                <div class="card-footer ml-auto mr-auto">
                                                    <a rel="tooltip" class="btn btn-flat btn-md btn-danger"
                                                        href="{{ route('configuracion.index_sistema') }}"
