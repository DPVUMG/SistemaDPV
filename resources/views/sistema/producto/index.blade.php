                ...
                <form method="post" action="{{ route('producto.store') }}" autocomplete="off" class="form-horizontal"
                    ...
                    <div class="card">
                        <div class="card-header card-header-success">
                            ...
                            <p class="card-category">{{ __('Registrar una nuevo producto en el sistema')
                                }}</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-7">
                                    <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }}">
                                        ...
                                        <input class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="{{ __('producto') }}" value="{{ old('nombre') }}"
                                            aria-required="true" />
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div
                                        ...
                                        <span id="producto_subcategoria-error" class="error text-danger"
                                            for="input-producto_subcategoria">{{ $errors->first('producto_subcategoria')
                                            }}</span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div
                                        ...
                                        <label for="variante_presentacion_id">Varaciones y Presentaciones</label>
                                        <select data-live-search="true" data-style="btn-default"
                                            class="selectpicker form-control{{ $errors->has('variante_presentacion_id') ? ' is-invalid' : '' }}"
                                            name="variante_presentacion_id" id="input-variante_presentacion_id">
                                            <option value="">Seleccionar una variación y presentación</option>
                                        ...
                                        <span id="variante_presentacion_id-error" class="error text-danger"
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="form-group{{ $errors->has('precio') ? ' has-danger' : '' }}">
                                        ...
                                        <input class="form-control{{ $errors->has('precio') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="{{ __('precio Q.') }}" value="{{ old('precio','0.00') }}"
                                            aria-required="true" />
                                        ...
                                        <div>
                                            <span class="btn btn-raised btn-round btn-rose btn-file">
                                                <span class="fileinput-new">Seleccionar foto</span><span
                                                    ...
                                                    foto</span>
                                                <input type="file" onchange="return fileValidation()" name="foto"
                                                    id="input-logotipo" />
                                            </span>
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <a rel="tooltip" class="btn btn-flat btn-md btn-danger" href="{{ route('producto.index') }}"
