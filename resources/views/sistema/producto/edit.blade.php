                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    ...
                                    <div class="checkbox-radios">
                                        <div class="form-check {{ $errors->has('temporada') ? ' has-danger' : '' }}">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="checkbox" name="temporada"
                                                    id="input-temporada" value="si" {{ $producto->temporada ? 'checked'
                                                : '' }}> Producto
                                                temporal
